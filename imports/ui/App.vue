      ...
      <v-container fluid>
        <v-row no-gutters>
          <v-col cols="3" v-for="review in reviewChoices" :key="review._id" class="ma-13">
            <ReviewButton @clickReview="checked" :reviewValue="review.description" :id="review._id" :style="{'background-color': review.color}"
...
console.log('format Email', rules._value)
